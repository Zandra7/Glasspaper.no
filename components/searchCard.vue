    ...
    <div>
        <div class="kurs-sertif-bg">
            <div class="kurs-sertif-content mx-32 my-10 text-white">
                ...
                <div class="relative">
                    <input type="text" class="pl-16 w-full py-2.5 px-8 text-center rounded-sm my-12 placeholder-text-black text-center border" placeholder="Søk i kurs og sertifisering">
